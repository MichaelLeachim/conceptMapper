...
(function () {
    ...
    */
    ...
    PasteHandler = Extension.extend({
        ...
        /* onBeforePasteHTML: (html:string)=>string
         * modify  html before pasting to editor
         */
        onBeforePasteHTML: function (html) {
            return html;
        },
        /* onBeforePasteText: (html:string)=>string
         * modify  text before pasting to editor
         */
        onBeforePasteText: function (text) {
            return text;
        },
        /* cleanTags: [Array]
        ...
        handlePaste: function (event, element) {
            ...
            if (event.clipboardData &&
                ...
                pastedHTML = this.onBeforePasteHTML(pastedHTML);
